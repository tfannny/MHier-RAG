...
class QuestionsProcessor:
    ...
    def process_all_questions(self, output_path: str = 'questions_with_answers.json', team_email: str = "", submission_name: str = "", submission_file: bool = False, pipeline_details: str = ""):
